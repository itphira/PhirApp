...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PhirAPP.MyMessagingService, PhirAPP", MyMessagingService.class, __md_methods);
	}
	...
	public MyMessagingService ()
	{
		...
		if (getClass () == MyMessagingService.class) {
			mono.android.TypeManager.Activate ("PhirAPP.MyMessagingService, PhirAPP", "", this, new java.lang.Object[] {  });
		}
	}
